      ...
      <CCol :md="12">
        <CCard class="mb-4">
          <CCardBody>
            <CRow>
              <CCol :sm="5">
                <h4 id="traffic" class="card-title mb-0">Empréstimos</h4>
                <div class="small text-medium-emphasis">Janeiro de 2022</div>
              </CCol>
              <CCol :sm="7" class="d-none d-md-block">
                ...
                >
                  <CButton color="secondary" variant="outline">Dia</CButton>
                  <CButton color="secondary" variant="outline" active
                    >Mês</CButton
                  >
                  <CButton color="secondary" variant="outline">Ano</CButton>
                </CButtonGroup>
              </CCol>
            </CRow>
            <CRow>
